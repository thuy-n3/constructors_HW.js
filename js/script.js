...
var Student = function(input){
	...
	this.knowledge = 0
	this.learn = function(knowledgeInput){
		this.knowledge += knowledgeInput  
	}
...
console.log(jasper.expertise === "hydroponics") 	
console.log(jasper.knowledge === 0)  				
jasper.learn(1)
console.log(jasper.knowledge === 1)	 				
jasper.learn(100)
console.log(jasper.learn)
console.log(jasper.knowledge === 101)  				
...
console.log(dontTellNobody.squeal() === mySecret);
...
//constructor1 : key 
//constructor2 : safe take two argu. 
	//first to be private. second is instacnce of key, private also 
	// add 'unlock' function that accepts a key      
	// if key matches the key that was used to create the Safe 
		//- return secret


var Key = function(){}

var Safe = function(privateInput, instanceOfKey){

	var private = privateInput 
	this.unlock = function(input){
		if (input === instanceOfKey){
			return private
		}
	}
}
...
console.log(safe.unlock(wrongKey) !== sensitive);
console.log(safe.unlock(rightKey) === sensitive);
